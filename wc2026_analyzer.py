...
class WC2026BettingAnalyzer:
   ...
   @st.cache_data(ttl=3600)
    def get_official_schedule(_self):
        """生成 2026 世界盃官方分組賽標準賽程（已完全校正台灣時間與正確對戰）"""
        corrected_schedule = [
            # 6/12 美國時間揭幕，換算台灣時間為 6/13～6/14
            {"日期": "06/13 (六)", "時間": "05:00", "組別": "A組 (官方揭幕戰)", "主隊": "墨西哥", "客隊": "南非", "主辦城市": "墨西哥城 (Azteca)"},
            {"日期": "06/13 (六)", "時間": "09:00", "組別": "D組", "主隊": "美國", "客隊": "牙買加", "主辦城市": "洛杉磯 (SoFi)"},
